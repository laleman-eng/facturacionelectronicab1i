DROP VIEW VID_VW_FEI_GUIA_IR_EXTRA; 
CREATE VIEW VID_VW_FEI_GUIA_IR_EXTRA 
AS 
SELECT
	 '' "TipoImp" ,
	0 "TasaImp" ,
...
GROUP BY T0."DocEntry" ,T0."ObjType" ,I0."U_CodImpto",S0."Rate" 
...
JOIN RPD4 T4 ON T4."DocEntry" = T0."DocEntry" 
		AND T4."LineNum" = T1."LineNum" AND UPPER(T4."StaCode") NOT IN ('IVA','IVA_EXE') 
JOIN OSTA S0 ON T4."StaCode" = s0."Code" 
JOIN "@VID_FEIMPADIC" I0 ON I0."Code" = T4."StaCode" 
WHERE 1 = 1 
AND UPPER(LEFT(N0."BeginStr", 1)) = 'E' 
