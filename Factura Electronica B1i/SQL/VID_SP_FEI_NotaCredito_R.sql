DROP PROCEDURE VID_SP_FEI_NotaCredito_R;
CREATE PROCEDURE VID_SP_FEI_NotaCredito_R
(
     IN DocEntry		Integer
...
BEGIN
	...
	docs1 = SELECT
		...
		FROM VID_VW_FEI_NotaCredito_R T0
		WHERE 1 = 1
	...
	docs2 = SELECT
			...
			,'0'								"IndGlobal"
		FROM VID_VW_FEI_NotaCredito_R_EXTRA T0 
		WHERE 1 = 1
			AND T0."DocEntry" = :DocEntry
			AND T0."ObjType" = :ObjType;		
