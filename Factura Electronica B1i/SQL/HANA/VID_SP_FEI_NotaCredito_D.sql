DROP PROCEDURE VID_SP_FEI_NotaCredito_D;
CREATE PROCEDURE VID_SP_FEI_NotaCredito_D
(
     IN DocEntry		Integer
...
BEGIN
	...
	FROM	  VID_VW_FEI_NotaCredito_D		T0
	LEFT JOIN VID_VW_FEI_NotaCredito_D_EXTRA T1 ON T0."DocEntry"    = T1."DocEntry"
