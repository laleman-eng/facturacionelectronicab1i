DROP PROCEDURE VID_SP_FEI_OINV_R;
CREATE PROCEDURE VID_SP_FEI_OINV_R
(
     IN DocEntry		Integer
...
BEGIN
	docs1 = SELECT
			...
			--,IFNULL(T0."IndGlobal",'0')						"IndGlobal"
			,'0'					"IndGlobal"
		FROM VID_VW_FEI_OINV_R T0 
		WHERE 1 = 1
	...
	docs2 = SELECT
			...
			,IFNULL(T0."RazonRef", '')			"RazonRef"
			,'0'								"IndGlobal"
		FROM VID_VW_FEI_OINV_R_EXTRA T0 
		WHERE 1 = 1
			AND T0."DocEntry" = :DocEntry
			AND T0."ObjType" = :ObjType;
