DROP PROCEDURE VID_SP_FEI_52_E;
CREATE PROCEDURE VID_SP_FEI_52_E
(
	 IN DocEntry	Integer
...
SELECT  T0."DocDate"														"FchEmis"
	...
	FROM VID_VW_FEI_52_E		  T0
	LEFT JOIN VID_VW_FEI_52_E_EXTRA T1 ON T0."DocEntry" = T1."DocEntry"
