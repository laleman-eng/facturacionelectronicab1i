DROP PROCEDURE VID_SP_FEI_NotaCredito_E;
CREATE PROCEDURE VID_SP_FEI_NotaCredito_E
(
     IN DocEntry	Integer
...
BEGIN
	...
	*/
	...
	FROM VID_VW_FEI_NotaCredito_E	   T0
	JOIN VID_VW_FEI_NotaCredito_E_EXTRA T1 ON T0."DocEntry" = T1."DocEntry"
